...
public class ReactTypefaceUtils {
    ...
    public static Typeface applyStyles(@Nullable Typeface typeface, int style, int weight,
        ...
        if (family != null) {
            typeface =
                ReactFontManager.getInstance().getTypeface(family, want, weight, assetManager);
